...
func examplesS3Json() (*asset, error) {
	...
	info := bindataFileInfo{name: "examples/s3.json", size: 532, mode: os.FileMode(0644), modTime: time.Unix(1742330478, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"examples": {nil, map[string]*bintree{
		...
		"plugin-test.json":           {examplesPluginTestJson, map[string]*bintree{}},
