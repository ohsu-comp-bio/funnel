...
type WorkerGoneRequest struct {
	// ID of the worker
	Id string `protobuf:"bytes,1,opt,name=id" json:"id,omitempty"`
}

func (m *WorkerGoneRequest) Reset()                    { *m = WorkerGoneRequest{} }
func (m *WorkerGoneRequest) String() string            { return proto.CompactTextString(m) }
func (*WorkerGoneRequest) ProtoMessage()               {}
func (*WorkerGoneRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }

func (m *WorkerGoneRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
type WorkerGoneResponse struct {
}

func (m *WorkerGoneResponse) Reset()                    { *m = WorkerGoneResponse{} }
func (m *WorkerGoneResponse) String() string            { return proto.CompactTextString(m) }
func (*WorkerGoneResponse) ProtoMessage()               {}
func (*WorkerGoneResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func init() {
	...
	proto.RegisterType((*WorkerGoneRequest)(nil), "ga4gh_task_ref.WorkerGoneRequest")
	proto.RegisterType((*WorkerGoneResponse)(nil), "ga4gh_task_ref.WorkerGoneResponse")
...
type SchedulerClient interface {
	...
	WorkerGone(ctx context.Context, in *WorkerGoneRequest, opts ...grpc.CallOption) (*WorkerGoneResponse, error)
}
...
func (c *schedulerClient) WorkerGone(ctx context.Context, in *WorkerGoneRequest, opts ...grpc.CallOption) (*WorkerGoneResponse, error) {
	out := new(WorkerGoneResponse)
	err := grpc.Invoke(ctx, "/ga4gh_task_ref.Scheduler/WorkerGone", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SchedulerServer interface {
	...
	WorkerGone(context.Context, *WorkerGoneRequest) (*WorkerGoneResponse, error)
}
...
func _Scheduler_WorkerGone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WorkerGoneRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SchedulerServer).WorkerGone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ga4gh_task_ref.Scheduler/WorkerGone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchedulerServer).WorkerGone(ctx, req.(*WorkerGoneRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Scheduler_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WorkerGone",
			Handler:    _Scheduler_WorkerGone_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
