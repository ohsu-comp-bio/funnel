...
// config/kubernetes-pv.yaml (517B)
...
func configKubernetesPvcYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/kubernetes-pvc.yaml", size: 309, mode: os.FileMode(0644), modTime: time.Unix(1732326881, 0)}
...
func configKubernetesPvYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/kubernetes-pv.yaml", size: 517, mode: os.FileMode(0644), modTime: time.Unix(1732327506, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x62, 0xa5, 0x30, 0x54, 0x11, 0xf3, 0x98, 0xe3, 0xc3, 0x75, 0xf8, 0x72, 0x29, 0x3a, 0x5c, 0x73, 0x31, 0x5b, 0x86, 0xc4, 0x99, 0x1d, 0x1b, 0xe0, 0xb4, 0xde, 0xf1, 0x3a, 0x28, 0xfe, 0xba, 0xea}}
	return a, nil
}
...
func configKubernetesExecutorTemplateYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/kubernetes-executor-template.yaml", size: 1232, mode: os.FileMode(0644), modTime: time.Unix(1732240371, 0)}
