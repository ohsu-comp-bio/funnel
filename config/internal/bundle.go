...
// config/kubernetes-executor-template.yaml (1.135kB)
// config/default-config.yaml (11.655kB)
// config/htcondor-template.txt (505B)
// config/kubernetes-template.yaml (1.354kB)
...
func configKubernetesExecutorTemplateYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/kubernetes-executor-template.yaml", size: 1135, mode: os.FileMode(0644), modTime: time.Unix(1729109797, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xd2, 0x50, 0x93, 0xa6, 0xe6, 0xeb, 0xd, 0x68, 0x45, 0x70, 0x64, 0xcc, 0x9c, 0xdd, 0xbf, 0x81, 0xd4, 0xd, 0xa9, 0x8d, 0xdd, 0xba, 0xe7, 0xa9, 0x23, 0xa, 0x69, 0xa5, 0x10, 0xdd, 0xd8, 0xf7}}
	return a, nil
}
...
func configDefaultConfigYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/default-config.yaml", size: 11655, mode: os.FileMode(0644), modTime: time.Unix(1729212983, 0)}
...
func configKubernetesTemplateYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/kubernetes-template.yaml", size: 1354, mode: os.FileMode(0644), modTime: time.Unix(1729214525, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x7f, 0x59, 0x5d, 0x1c, 0xec, 0xeb, 0x76, 0x2c, 0x4e, 0xe3, 0xe4, 0x89, 0x72, 0xc4, 0xde, 0x87, 0x68, 0x66, 0x9b, 0xc7, 0x30, 0x87, 0xd8, 0x56, 0xc4, 0xd8, 0x38, 0xef, 0x82, 0xa0, 0x2b, 0x62}}
	return a, nil
}
