...
func configDatastoreIndexYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/datastore/index.yaml", size: 882, mode: os.FileMode(0644), modTime: time.Unix(1743212560, 0)}
...
func configDefaultConfigYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/default-config.yaml", size: 13791, mode: os.FileMode(0644), modTime: time.Unix(1743212560, 0)}
