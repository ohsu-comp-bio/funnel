...
type Kubernetes struct {
	...
	// 18: NodeSelector for scheduling jobs onto specific nodes
	NodeSelector  string `protobuf:"bytes,13,opt,name=NodeSelector,proto3" json:"NodeSelector,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Kubernetes) GetNodeSelector() string {
	if x != nil {
...
const file_config_config_proto_rawDesc = "" +
	...
	"\bPassword\x18\x04 \x01(\tR\bPassword\"\x99\x04\n" +
	"\n" +
	"Kubernetes\x12\x1a\n" +
	...
	"\x11DisableJobCleanup\x18\f \x01(\bR\x11DisableJobCleanup\x12\"\n" +
	"\fNodeSelector\x18\r \x01(\tR\fNodeSelectorB(Z&github.com/ohsu-comp-bio/funnel/configb\x06proto3"
