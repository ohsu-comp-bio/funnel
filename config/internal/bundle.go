...
// config/kubernetes-executor-template.yaml (1.521kB)
// config/default-config.yaml (11.655kB)
// config/htcondor-template.txt (505B)
// config/kubernetes-template.yaml (1.785kB)
...
func configKubernetesExecutorTemplateYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/kubernetes-executor-template.yaml", size: 1521, mode: os.FileMode(0644), modTime: time.Unix(1730912888, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x59, 0x92, 0x28, 0x98, 0xde, 0x1c, 0xe2, 0x20, 0xc2, 0x47, 0x66, 0x4c, 0x5d, 0x7e, 0xfd, 0x12, 0x52, 0x5c, 0x93, 0x94, 0x63, 0xa6, 0x33, 0x67, 0xe6, 0x7a, 0x21, 0x75, 0x90, 0xa, 0xe3, 0xb9}}
	return a, nil
}
...
func configKubernetesTemplateYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/kubernetes-template.yaml", size: 1785, mode: os.FileMode(0644), modTime: time.Unix(1730912881, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x1f, 0x41, 0xd9, 0xeb, 0x65, 0x4e, 0x19, 0x40, 0xd3, 0x9b, 0xbe, 0x1, 0xe, 0xb5, 0xa8, 0x2f, 0xaa, 0x21, 0xd7, 0x2a, 0x40, 0xd6, 0x36, 0x60, 0x2c, 0xe2, 0x5c, 0x9d, 0x5a, 0x9d, 0xd1, 0x2}}
	return a, nil
}
