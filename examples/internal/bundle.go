...
func examplesGcpBatchJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "examples/gcp-batch.json", size: 557, mode: os.FileMode(0644), modTime: time.Unix(1765313626, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x83, 0x2d, 0xa2, 0xe7, 0x89, 0x92, 0x8f, 0x3e, 0xe4, 0x92, 0xfd, 0x78, 0x76, 0x3d, 0xf4, 0xec, 0x1b, 0x26, 0x90, 0x3b, 0xe6, 0xb9, 0x13, 0x3d, 0x9b, 0x80, 0x27, 0x88, 0xee, 0x9c, 0xde, 0x4}}
	return a, nil
}
