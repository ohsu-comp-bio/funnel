...
func (_m *Database) AssignJob(_a0 *tes.Job, _a1 *pbf.Worker) {
	_m.Called(_a0, _a1)
}
...
func (_m *Database) GetWorkers(_a0 context.Context, _a1 *pbf.GetWorkersRequest) (*pbf.GetWorkersResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *pbf.GetWorkersResponse
	if rf, ok := ret.Get(0).(func(context.Context, *pbf.GetWorkersRequest) *pbf.GetWorkersResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *pbf.GetWorkersRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Database) UpdateWorker(_a0 context.Context, _a1 *pbf.Worker) (*pbf.UpdateWorkerResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *pbf.UpdateWorkerResponse
	if rf, ok := ret.Get(0).(func(context.Context, *pbf.Worker) *pbf.UpdateWorkerResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *pbf.Worker) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
