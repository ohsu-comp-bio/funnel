...
func configDefaultConfigYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/default-config.yaml", size: 9769, mode: os.FileMode(420), modTime: time.Unix(1511381349, 0)}
