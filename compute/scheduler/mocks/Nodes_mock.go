...
// SchedulerServiceServer is an autogenerated mock type for the SchedulerServiceServer type
type SchedulerServiceServer struct {
	mock.Mock
}

// DeleteNode provides a mock function with given fields: _a0, _a1
func (_m *SchedulerServiceServer) DeleteNode(_a0 context.Context, _a1 *scheduler.Node) (*scheduler.DeleteNodeResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *scheduler.DeleteNodeResponse
	if rf, ok := ret.Get(0).(func(context.Context, *scheduler.Node) *scheduler.DeleteNodeResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*scheduler.DeleteNodeResponse)
		}
	}
...
func (_m *SchedulerServiceServer) GetNode(_a0 context.Context, _a1 *scheduler.GetNodeRequest) (*scheduler.Node, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *SchedulerServiceServer) ListNodes(_a0 context.Context, _a1 *scheduler.ListNodesRequest) (*scheduler.ListNodesResponse, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *SchedulerServiceServer) PutNode(_a0 context.Context, _a1 *scheduler.Node) (*scheduler.PutNodeResponse, error) {
	ret := _m.Called(_a0, _a1)
