...
func examplesMd5sumJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "examples/md5sum.json", size: 737, mode: os.FileMode(416), modTime: time.Unix(1706586712, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func examplesHelloWorldJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "examples/hello-world.json", size: 187, mode: os.FileMode(416), modTime: time.Unix(1706586712, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
